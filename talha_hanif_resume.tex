...
\section{Projects}
  \resumeSubHeadingListStart
        \resumeSubItem{Cyclist Detection}
      {Implemented the paper ``ACF Based Region Proposal Extraction for YOLOv3 Network Towards High-Performance Cyclist Detection in High Resolution Images'' and tried improving the performance using Depth images and Attention
}
\begin{itemize}
  	  \item Precision : 0.75
  	  \item Recall : 0.76
